...
-- ====================================================================
-- 6. សំណួរគំរូសម្រាប់ប្រើប្រាស់ (Useful Queries)
-- ====================================================================

-- Query 1: ទាញយកបញ្ជីពិន្ទុសិស្សទាំងអស់ ព្រមទាំងចំណាត់ថ្នាក់
-- SELECT * FROM v_student_scores ORDER BY rank ASC;

-- Query 2: គណនាមធ្យមភាគថ្នាក់តាមមុខវិជ្ជានីមួយៗ (Class Subject Averages)
-- SELECT 
--     ROUND(AVG(khmer), 2) AS avg_khmer,
--     ROUND(AVG(math), 2) AS avg_math,
--     ROUND(AVG(physics), 2) AS avg_physics,
--     ROUND(AVG(chemistry), 2) AS avg_chemistry,
--     ROUND(AVG(biology), 2) AS avg_biology,
--     ROUND(AVG(english), 2) AS avg_english,
--     ROUND(AVG(average), 2) AS class_overall_average
-- FROM v_student_scores;

-- Query 3: រកសិស្សទទួលបាននិទ្ទេស A
-- SELECT * FROM v_student_scores WHERE grade = 'A';
